...
gmsh.model.occ.addRectangle(xRectDimes - L2_rect/2, yRectDimes - L1_rect/2, zRectDimes, L2_rect, L1_rect, tag=TagRectDimes, roundedRadius=0.)
...
gmsh.model.occ.addRectangle(xRectDimes - L2_rect/2, yRectDimes - L1_rect/2 - Strip_distance - Strip_width , zRectDimes, L2_rect, Strip_width, tag=TagStrip_L_Dimes, roundedRadius=0.)
...
gmsh.model.occ.addRectangle(xRectDimes - L2_rect/2 , yRectDimes + L1_rect/2 + Strip_distance, zRectDimes, L2_rect, Strip_width, tag=TagStrip_R_Dimes, roundedRadius=0.)
...
DiMESTag_real = list(set(DiMESTag) - set(TagBoundBox))
...
gmsh.write("DiMES_SiC_amorphous_finermesh.msh")
