...
def makeInitNC(dim,area,Conc):
    ...
    os.system("mv surface_evolution_C_Si.nc /Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_7/input/")
...
BackgroundPlasmaFile='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_7/profiles_created.nc'
