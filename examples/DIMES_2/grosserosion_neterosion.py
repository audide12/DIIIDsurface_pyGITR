...
for i in range(total_runs):
    ...
    FileNameHistoryCarbon='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_2/output_C_'+str(number)+'/positions.nc'
    ...
    FileNameHistorySilicon='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_2/output_Si_'+str(number)+'/positions.nc'
...
net_fit = 3.6e19+1e19*(1-0.7*time_fit)
plt.figure()
...
plt.plot(Time[0,:],Gamma_Si_grosserosion[surface_in_question,:],marker='^',label='GITR + Surface model',linewidth=2,color='red')
plt.plot(Time_experiment_SiC_crystal-2.5, Si_grosserosion_experiment_SiC_crystal, label='DiMES Experiment - SiC crystalline',linewidth=2,color='green',alpha=0.7)
#plt.plot(Time_experiment1, Si_grosserosion_experiment1, label='DiMES Experiment - - SiC amorphous')

plt.ylabel("Erosion (m^-2 s^-1)",fontsize=18,color='blue')
plt.xlabel("Time (s)",fontsize=18,color='blue')

plt.legend()
plt.title(r"Si Gross Erosion, $\alpha_C$ = 0.02, $\Delta_{implant}$ = 10 nm",fontsize=20,color='blue')
plt.yticks(fontsize=16)
plt.xticks(fontsize=16)
plt.show()

#%%
Gamma_Si_grosserosion_0pt02_40nm = Gamma_Si_grosserosion[surface_in_question,:]
time_grosserosion_0pt02_40nm  = Time[0,:]

# time_grosserosion_0pt02_40nm  = Time[0,:]
# time_grosserosion_0pt02_10nm  = Time[0,:]

# time_grosserosion_0pt015_10nm  = Time[0,:]
# time_grosserosion_0pt025_10nm  = Time[0,:]

# time_grosserosion_0pt0185_10nm  = Time[0,:]
# time_grosserosion_0pt0185_2nm  = Time[0,:]
#Gamma_Si_grosserosion_0pt015_10nm Gamma_Si_grosserosion_0pt0185_10nm  Gamma_Si_grosserosion_0pt0185_2nm
#%%
import pandas as pd
...
plt.plot(time_grosserosion_0pt02_10nm+2.1,Gamma_Si_grosserosion_0pt02_10nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.02, $\Delta_{implant}$ = 10 nm)",linewidth=2,color='red')
plt.plot(time_grosserosion_0pt02_40nm+1.5,Gamma_Si_grosserosion_0pt02_40nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.02, $\Delta_{implant}$ = 40 nm)",linewidth=2,color='blue')

plt.plot(time_grosserosion_0pt02_80nm+0.7,Gamma_Si_grosserosion_0pt02_80nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.02, $\Delta_{implant}$ = 80 nm)",linewidth=2,color='orange')

plt.plot(time_grosserosion_0pt015_10nm+2,Gamma_Si_grosserosion_0pt015_10nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.015, $\Delta_{implant}$ = 10 nm)",linewidth=2,color='cyan')

plt.plot(time_grosserosion_0pt025_10nm+2.1,Gamma_Si_grosserosion_0pt025_10nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.025, $\Delta_{implant}$ = 10 nm)",linewidth=2,color='purple')

plt.plot(time_grosserosion_0pt0185_2nm+2.25,Gamma_Si_grosserosion_0pt0185_2nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.0185, $\Delta_{implant}$ = 2 nm)",linewidth=2,color='black')

plt.plot(time_grosserosion_0pt0185_10nm+2.1,Gamma_Si_grosserosion_0pt0185_10nm,marker='^',label=r"GITR + Surface model ($\alpha_C$ = 0.0185, $\Delta_{implant}$ = 10 nm)",linewidth=2,color='brown')

plt.plot(Time_experiment_SiC_crystal, Si_grosserosion_experiment_SiC_crystal, label='DiMES Experiment - SiC crystalline',linewidth=2,color='green',alpha=0.7)
plt.plot(Time_experiment1, Si_grosserosion_experiment1, label='DiMES Experiment - SiC amorphous')

plt.ylabel(r"Erosion $\times(10^{20} m^{-2} s^{-1})$",fontsize=18,color='blue')
plt.xlabel("Time (s)",fontsize=18,color='blue')

#plt.legend(fontsize="20")
plt.title("Si Gross Erosion",fontsize=20,color='blue')
