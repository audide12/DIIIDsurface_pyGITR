...
FileNameHistory='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_2/output_Si_3/history.nc'
...
g.Plot_Geom(["LargeRectangle","LeftStrip","RightStrip"],fig=fig, ax=ax)
