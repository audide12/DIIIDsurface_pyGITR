...
FileNameHistory='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_C_5/positions.nc'
...
FileNameHistory='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_Si_5/positions.nc'
...
Delta_t_surface_estimate_C = (Delta_implant*n_atom_C*Stopping_criteria)/RHS_C

Delta_t_surface_estimate_Si = (Delta_implant*n_atom_Si*Stopping_criteria)/RHS_Si

Delta_t_surface_estimate_SiC = (Delta_implant*n_atom_SiC_crystal*Stopping_criteria)/RHS_SiC
...
for t in range(1,int(Time_steps)):
    ...
    #print(t)
    new_entry_C = new_entry_C + Delta_Time*(Gamma_C_net - Gamma_C_bulk)/(Delta_implant*n_atom_Si)
    

    new_entry_Si = new_entry_Si + Delta_Time*(Gamma_Si_net - Gamma_Si_bulk)/(Delta_implant*n_atom_Si)
    
    new_entry_SiC = new_entry_SiC + Delta_Time*(Gamma_SiC_net - Gamma_SiC_bulk)/(Delta_implant*n_atom_SiC_crystal)
