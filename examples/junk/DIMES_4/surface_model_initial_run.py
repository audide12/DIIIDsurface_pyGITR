...
FileNameHistory='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_C_1/positions.nc'
...
FileNameHistory='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_Si_1/positions.nc'
...
for t in range(1,int(Time_steps)):
    ...
    #print(t)
    new_entry_C = new_entry_C + Delta_Time*(Gamma_C_net - Gamma_C_bulk)/(Delta_implant*n_atom_C)
