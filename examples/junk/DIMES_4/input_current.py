...
#os.system("rm /Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_2/input/particleConf.nc")
...
ParticleFile='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/input/particleConf_Si.nc'
GeometryFile='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/input/gitrGeom.cfg'
B0 = 2.25
nP=10
dt=1e-9
nT=1e5
...
p.SetAttr('x',np.linspace(1.46,1.5,nP))   # R 
p.SetAttr('y',0.0)   # y
p.SetAttr('z',np.linspace(-1.247,-1.240,nP))
...
def make_input(nP,dt,nT,ParticleFile='particleConf_Si.nc',GeometryFile='gitrGeom.cfg',folder='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/input/'):
    ...
    i.Input['flags']['USETHERMALFORCE'] = 0#1
    i.Input['flags']['USEPERPDIFFUSION'] = 0#1
    i.Input['flags']['USESURFACEMODEL'] = 1 ##  changed from 1
    i.Input['flags']['USESHEATHEFIELD'] = 1#1 # 1 or 0, on or off
    i.Input['flags']['USEPRESHEATHEFIELD'] = 1#1  # 1 or 0, on or off
    i.Input['flags']['USECOULOMBCOLLISIONS'] = 0#1
    i.Input['flags']['USEFRICTION'] = 0#1
    i.Input['flags']['USEANGLESCATTERING'] = 0#1
    ...
    i.Input['flags']['USE_IONIZATION'] = 0
    i.Input['flags']['USE_RECOMBINATION'] = 0
    # Set the INTERP flags
    i.Input['flags']['BFIELD_INTERP'] = 0 # 2 changed 
    i.Input['flags']['EFIELD_INTERP'] = 0
    i.Input['flags']['PRESHEATH_INTERP'] = 0 # 2 # 3
    i.Input['flags']['DENSITY_INTERP'] = 0#2
    i.Input['flags']['TEMP_INTERP'] = 0#2
    i.Input['flags']['FLOWV_INTERP'] = 0#2 #2 # 3, 0 const from file, 1 Lc based, 2 2D, 3 3D
    i.Input['flags']['GRADT_INTERP'] = 0#2 #2 # 3, 1 R, 2 R+Z, 3 R+Z+Y
    ...
    i.Input['backgroundPlasmaProfiles']['FlowVelocity']['flowVr'] = 0#20000   # redundant
...
#%%
import pyGITR
ParticleFile='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/input/particleConf_C.nc'
nP = 10000
p = pyGITR.ParticleDistribution()
p.SetAttr('Np', nP)
