...
def makeInitNC(dim,area,Conc):
    ...
    os.system("mv surface_evolution_C_Si.nc /Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/input/")
...
Delta_implant_amorphous = 50e-09  # implantation layer may be shorter than that of SiC layer
alpha_c = 0.0175     # Carbon concentration in the background plasma
Delta_t_gitr = 1e-9
...
BackgroundPlasmaFile='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/profiles_created.nc'
