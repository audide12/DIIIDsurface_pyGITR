...
for i in range(total_runs):
    ...
    FileNameHistoryCarbon='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_C_'+str(number)+'/positions.nc'
    ...
    FileNameHistorySilicon='/Users/de/Research/DIIIDsurface_pyGITR/examples/DIMES_4/output_Si_'+str(number)+'/positions.nc'
...
# Gamma_C_grosserosion  = Gamma_C_grosserosion/total_runs
# Gamma_Si_grosserosion = Gamma_Si_grosserosion/total_runs

# Gamma_C_neterosion  = Gamma_C_neterosion/total_runs
# Gamma_Si_neterosion = Gamma_Si_neterosion/total_runs
...
surface_in_question = 195
plt.figure()

plt.plot(Time[0,:],Gamma_Si_grosserosion[surface_in_question,:],marker='^',label='GITR + Surface model')
plt.plot(Time_experiment_SiC_crystal, Si_grosserosion_experiment_SiC_crystal, label='DiMES Experiment - SiC crystalline')
...
plt.legend()
plt.title("Si Erosion in Surface Element %d" % surface_in_question)
plt.show()
