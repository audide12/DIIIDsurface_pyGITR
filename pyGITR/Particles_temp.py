...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  7 15:03:20 2023
...
class Distribs():
    ...
    def Gaussian(x: np.ndarray = np.linspace(-15000, 15000, 100000), sigma: float = 1.0, mu: float = 0.0, beta: float = 0.0, Normalized=True):
        f = beta*np.exp(-((x-mu)/sigma)**2)
