...
ParticleFile='input/particleConf.nc'
...
p.SetAttr(['x','y'],'Uniform',xmin=0.0005,xmax=0.001) #set values of y and z with uniformly distributed values between -0.05 and 0.05
p.SetAttr('z',0.0001) # set all values of x to -0.01
p.SetAttr(['x','y'],0.0005) #set values of y and z with uniformly distributed values between -0.05 and 0.05
...
p.WriteParticleFile('input/particleConf.nc')
